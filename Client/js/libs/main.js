...
(function() {
  var $, Binary, Float, Graph, bluebird, fs, init, log, redis, toml;
  ...
  init = function(config) {
    var binaries, client, db, floats, graphs, ip, k, ref, ref1, ref2, results, v;
    ...
    for (k in ref2) {
      v = ref2[k];
      results.push(floats.push(new Float(v[0], v[1], client)));
    }
    return results;
  };
